let resumeData = {
    ...
    "socialLinks":[
        ...
        {
          "name":"github",
          "url":"http://github.com/humesandrew/",
          "className":"fa fa-github"
        },
      ],
    "aboutme":"Just finished coding bootcamp.",
    "address":"Denver, CO",
    ...
    "portfolio":[
      ...
      "project":[
        ...
        },
        {
          "id":"7",
          "name":"Day Scheduler",
          "description":"A single web page to track your daily schedule.",
          "technologies":"JavaScript, HTML, CSS",
        ...
        },
        {
          ...
          "description":"A back-end application that allows you to track, create, and manage employees of your virtual company.",
